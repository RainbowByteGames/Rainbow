...
namespace HappiiDreamer.Rainbow.Graphics
{
    ...
    public static class SpriteBatchExt
    {
        ...
        public static void Draw(this SpriteBatch batch, Texture2D texture, Transform2D transform, Rectangle sourceRectangle, Color color, Vector2 normalOrigin, SpriteEffects effects, int layer)
        {
        ...
        {
            batch.Draw(sprite.Texture, transform, sprite.SourceRectangle, sprite.Color, sprite.Origin, sprite.Effects, sprite.Layer);
        }
    }
}
